        ...
        <div class="md:w-4/12 bg-white p-6 rounded-lg shadow-xl">
            <form>
                <div class="mb-5">
                    ...
                    <input id="name" type="text" name="name" placeholder="Name" class="border p-3 w-full rounded-lg"/>
                </div>
                ...
                <div class="mb-5">
                    ...
                    <input id="username" type="text" name="username" placeholder="UserName" class="border p-3 w-full rounded-lg"/>
                </div>
                ...
                <div class="mb-5">
                    ...
                    <input id="email" type="email" name="email" placeholder="Email" class="border p-3 w-full rounded-lg"/>
                </div>
                ...
                <div class="mb-5">
                    ...
                    <input id="password" type="password" name="password" placeholder="Password" class="border p-3 w-full rounded-lg"/>
                </div>
